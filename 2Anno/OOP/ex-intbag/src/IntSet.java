...
public class IntSet {
	...
	/**
	 * @param: elts.
	 *             REQUIRE be null. EFFECT initialize this to a new set, which
	 ...
	 * 
	 * @param s:
	 *            a set to be duplicated EFFECT initialize this to a new set
	 *            that contains all and only the elements of s.
	 */
	...
	/**
	 * @return: the index of the first x if it is present in this ; return -1 if not
	 *          present
	 */
